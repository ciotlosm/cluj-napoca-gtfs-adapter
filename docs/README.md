...
- `csv-timetable-format.md` was reverse-engineered from the
  ...
  since mid-2026.
- `reconciliation-rules.md` and `architecture.md` are first-draft — they will
  evolve as the reconciliation code lands and we get more empirical feedback
